...
import treebolic.provider.wordnet.kwi.AndroidDataManager
import treebolic.provider.wordnet.kwi.BaseDataManager
...
class Provider2 : Provider() {
    ...
    override fun getDataManager(): BaseDataManager {
